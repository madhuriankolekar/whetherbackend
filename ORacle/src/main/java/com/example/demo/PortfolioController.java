...
//    
    ...
    public List<String> getAllNames() {
        return portfolioService.getAllNames();//findByCheckboxDescIn
    }
    
    @GetMapping("/advisory-status")
    public List<String> getAdvisoryStatus() {
        return portfolioService.getIsAdvisoryOnlyStatus();
    }
}
